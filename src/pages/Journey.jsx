  ...
  const data = [
    {
      ...
      content: (
        <div>
          <p
            className="text-neutral-800 dark:text-neutral-200 text-xs md:text-base font-normal mb-8">
            Unleash Your Creativity: Our widgets are designed to spark your imagination and take your projects to the next level.
          </p>
          <div className="">
            <img
              src="/widget.png"
      ...
      content: (
        <div>
          <p
            ...
            Explore IoT solutions tailored for the QSR and hospitality industry in our marketplace
          </p>
          <div className="">
            <img
              src="Iot.png"
